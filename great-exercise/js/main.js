...
if (localStorage.getItem("bayGioLa") == "Giáo Viên") {
  ...
  document.querySelector("#hello-user").innerText =
...
if (localStorage.getItem("bayGioLa") == "Sinh Viên") {
  ...
  document.querySelector("#hello-user").innerText =
    "Xin chào: " +
    (teachers[now].students[sinhVienThu].name
      ? teachers[now].students[sinhVienThu].name
      : "");
  document.querySelector("#log-out-btn").style.display = "block";
  document.querySelector("#showScores").style.display = "initial";
...
var label = document.querySelectorAll(
  ".sign-up__account label,.login__account label"
);
var input = document.querySelectorAll(
  ".sign-up__account input,.login__account input"
);
